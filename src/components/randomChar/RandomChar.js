...
const View = ({ char }) => {
	...
	let descriptionHero = description === '' ? 'No info provided(' : description;
	if (descriptionHero && descriptionHero.length > 100) {
		descriptionHero = descriptionHero.slice(0, 100) + '...';
	}
	...
	return (
		<div className='randomchar__block'>
			...
			<div className='randomchar__info'>
				...
				<p className='randomchar__descr'>{descriptionHero}</p>
